...
<body>
    ...
    <table class="table table-bordered mt-5">
        ...
        <tbody>
            <?php
            include('connect.php');
            $get_payment = "SELECT p.*, s.name AS shipping_method, o.tracking_number, o.receiver_name, o.receiver_address 
                            FROM `payment` p 
            ...
            if ($row_count == 0) {
                echo "<tr><td colspan='9' class='text-center text-danger'>No payment received yet</td></tr>";
            } else {
                $number = 0;
                while ($row_data = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<tr>
                        ...
                        <td>{$row_data['date']}</td>
                        <td>{$row_data['shipping_method']}</td> <!-- Ensure correct column name -->
