                 ...
                 while($row=mysqli_fetch_assoc($result_query)){
                    ...
                    <div class='card'>
                        ...
                        <div class='card-body'>
                            ...
                            <a href='clientpage.php?add_to_cart=$product_id' class='btn btn-info btn-light-pink'>Add to Cart</a>
...
function getcategories (){
    ...
    $select_categories="Select * from `categories`";
                ...
                while($row_data=mysqli_fetch_assoc($result_categories)){
                    ...
                    <a href='clientpage.php?category=$category_id' class='nav-link text-light'>$category_title</a>
                    </a>
                </li>";
                }
}
...
if(!isset($_GET['category'])){
    ...
    $select_query="Select * from `products` where product_id=$product_id";
                 ...
                 while($row=mysqli_fetch_assoc($result_query)){
                    ...
                    <div class='card'>
                        ...
                        <div class='card-body'>
                            ...
                            <p class='card-text'>Price: ₱$product_price</p>
                            <a href='clientpage.php?add_to_cart=$product_id' class='btn btn-info btn-light-pink'>Add to Cart</a>
                            <a href='clientpage.php' class='btn btn-secondary'>Go home</a>
                        </div>
                    </div>
                </div>
                ...
                <div class='row'>
                    <div class='col-md-12 text-custom-pink mb-5'>
            ...
            if(!isset($_GET['my_orders'])){
                if(!isset($_GET['delete_account'])){
                    ...
                    if ($row_count > 0) {
                       ...
                       <p class='text-center'> <a href='clientpage.php' class='text-dark'>Explore Products</a></p>";
                    }                    
                }
            }
        }
...
function get_product_id(){
    // Check if the product ID is passed via GET method
    if(isset($_GET['product_id'])) {
