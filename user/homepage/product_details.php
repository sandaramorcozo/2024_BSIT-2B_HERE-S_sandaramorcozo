...
?>
    ...
    ?>
        ...
        <?php else: ?>
        <p>Please <a href="sample_login.php">log in</a> to leave a comment or review.</p>
        <?php endif; ?>
    </div>
